...
"""
We may need to change the shape of the table in the config file according to the real experiment 
"""
...
if __name__ == "__main__":
    ...
    """
    Add the object recognitio we used (RANSAC)
    Add the grapit! plugin
    """
    # Get block to pick
